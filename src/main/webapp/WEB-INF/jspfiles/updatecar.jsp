...
<div class="card-container">
    <div class="info-card">
        <h5 class="card-title text-center">Update Car</h5>
        <form action="/updatingcar" method="post" class="mt-4">
            <!-- Car ID (hidden field) -->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="carBrand" name="carBrand" value="${car.carBrand}" required>
            </div>
            <!-- Registration Number -->
            <div class="form-group">
