...
<div class="card-container">
    <div class="info-card">
        <h5 class="card-title text-center">Appointments</h5>
        <div class="list-group mt-4">
            <c:forEach items="${appointments}" var="appointment">
                <a href="/viewappointments/${appointment.appointmentId}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1">${appointment.name} - ${appointment.type}</h5>
                        <p class="mb-1">${appointment.car.getCarName()}</p>
                    </div>
                    <div>
