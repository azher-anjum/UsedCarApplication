...
@GetMapping("/addappointment")
    public ModelAndView addAppointment() {
        ...
        mv.addObject("cars", carRepo.findByAvailable(true));
        return mv;
    }
...
<div class="card-container">
    <div class="info-card">
        <h5 class="card-title text-center">Create New Appointment</h5>
        <form action="/submitappointment" method="post" class="mt-4">
            <!-- Name -->
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="type" name="type" onchange="toggleCarDropdown()">
            ...
            <div class="form-group" id="carDropdown" style="display: none">
                ...
                <select class="form-control" id="car" name="car">
                    <c:forEach var="car" items="${cars}">
                        <option value="${car.carId}">Model : ${car.carName} -- Price : ₹${car.price}</option>
                    </c:forEach>
                </select>
