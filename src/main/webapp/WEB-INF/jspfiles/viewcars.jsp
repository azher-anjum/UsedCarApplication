    ...
    <div class="info-card">
        ...
        <div class="list-group mt-4">
            <c:forEach items="${cars}" var="car">
                <a href="/viewcars/${car.carId}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1">${car.carName} - ${car.carBrand}</h5>
                        <p class="mb-1">${car.registrationNumber}</p>
                    </div>
                    <h5 class="text-muted mb-0">₹${car.price}</h5>
                </a>
            </c:forEach>
        </div>
    </div>
