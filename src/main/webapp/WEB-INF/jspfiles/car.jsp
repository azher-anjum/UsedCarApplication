...
<div class="card-container">
    <div class="info-card">
        <h5 class="card-title text-center">Car Details</h5>
        <div class="card mt-4">
            <div class="card-body">
                <h5 class="card-title">${car.carName} - ${car.carBrand}</h5>

<%--                    <p class="card-text">Car: ${car.carName}</p>--%>
<%--                    <p class="card-text">Brand: ${car.carBrand}</p>--%>
                    <p class="card-text">RC: ${car.registrationNumber}</p>
                    <p class="card-text">Fuel: ${car.fuelType}</p>
                    <p class="card-text">Price: ₹${car.price}</p>

                <div class="text-center">
                    <a href="/updatecar/${car.carId}" class="btn btn-primary mr-2">Update</a>
                    <a href="/deletecar/${car.carId}" class="btn btn-danger">Delete</a>
                </div>
            </div>
        </div>
    </div>
